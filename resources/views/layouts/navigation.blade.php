        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    {{-- Logo akan mengarah ke dashboard yang sesuai --}}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    {{-- TAMPILKAN MENU INI HANYA UNTUK ADMIN/PETUGAS --}}
                    @if (Auth::guard('web')->check())
                        ...
                        <x-nav-link :href="route('biaya-spp.index')" :active="request()->routeIs('biaya-spp.*')">
                            {{ __('Biaya SPP') }}
                        </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        {{-- Link Profile hanya untuk Admin/Petugas --}}
                        @if (Auth::guard('web')->check())
                        ...
                        {{-- Form logout akan disesuaikan otomatis --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
             ...
             @if (Auth::guard('web')->check())
                ...
                <x-responsive-nav-link :href="route('biaya-spp.index')" :active="request()->routeIs('biaya-spp.*')">
                    {{ __('Biaya SPP') }}
                </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ Auth::guard('wali')->check() ? route('wali.logout') : route('logout') }}">
                    @csrf
                    <x-responsive-nav-link :href="Auth::guard('wali')->check() ? route('wali.logout') : route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
